...
export class CreateQuatation extends Component {
    ...
    create_number(){
        this.props.create_number(this.props.match.params.id,"quotation")
    }
    getPrint=()=>{
    ...
    render() {
        ...
        return (
            ...
            <div >
                ...
                {!this.props.jobcard_details.jobCardDetails.quotation_number?
                   <Button className="export-pdf k-button" onClick={()=>this.create_number()}>Generate Quotation Number</Button>
                    :null
                }
                </div>    
                </div>
                <div className="page-container hidden-on-narrow" id="printArea">
                    <div className="pdf-page size-a4" style={{  width: '8.3in',   
                        ...
                        <span className="invoice-number">Quotation</span>
                        </div>
                    ...
                    <p style={{paddingTop: '20px'}}>
                        Quotation No.: {this.props.jobcard_details.jobCardDetails.quotation_number}<br />
                        Quotation Date: {moment().format("DD-MMM-YYYY")}<br />
                        Validity: 7 days
                    </p>
                    </div>
